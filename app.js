...
function valueLabel(value){
 ...
 if(LANG==='zh-CN'){
  const replacements=[
   ['press the button','按键操作'],['semi-in-ear','半入耳式'],['open-ear','开放式'],['open ear','开放式'],['over-ear','包耳式'],['over ear','包耳式'],['on-ear','贴耳式'],['on ear','贴耳式'],['built-in','内置'],['active noise cancellation','主动降噪'],['noise cancellation','降噪'],['low-latency mode','低延迟模式'],['battery life','续航'],['charging case','充电仓'],['charging dock','充电底座'],['mechanical switches','机械轴'],['optical switches','光微动'],['hall-effect switches','磁轴'],['hot-swappable','支持热插拔'],['aluminum alloy','铝合金'],['magnesium alloy','镁合金'],['carbon fiber','碳纤维'],['south-facing','南向'],['north-facing','北向'],['backlight off','关闭背光'],['minimum brightness','最低亮度'],['up to','最高'],['not supported','不支持'],['supported','支持'],['tri-mode','三模'],['dual-mode','双模'],['wireless','无线'],['wired','有线'],['bluetooth','蓝牙'],['adaptive','自适应'],['button','按键'],['hours','小时'],['black','黑色'],['white','白色'],['gray','灰色'],['red','红色']
  ];
